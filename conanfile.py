...
class MeanShiftClusteringConan(ConanFile):
    ...
    description = "Perform Mean Shift Clustering on HDSP data. "
    topics = ("hdps", "plugin", "data", "mean shift clustering")
    url = "https://github.com/hdps/MeanShiftClustering"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/MeanShiftClustering")
        cmake.verbose = True
        return cmake
